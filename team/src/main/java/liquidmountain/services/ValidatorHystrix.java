...
public class ValidatorHystrix extends HystrixCommand<String> implements UrlValidatorAndChecker{
    private final String url;
    public boolean valid = true;
    public boolean alive = true;

    public ValidatorHystrix(String url){
    ...
    protected String getFallback() {
        ...
        return "Vuelve a intentar acortar " + url + "!";
    }
